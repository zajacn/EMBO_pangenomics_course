...
Now the code below will help you visualize the synteny. If you download the ggggenomes_viz.sequence_lengths.tsv and ggggenomes_viz.links.tsv you can use the code below to visualise it on your own in R.
