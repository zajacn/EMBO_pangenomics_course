...
pankmer adj-matrix -i Drosophila_index.tar -o Drosophila_index_adj_matrix.csv
pankmer clustermap -i Drosophila_index_adj_matrix.csv --metric jaccard -o Drosophila_jaccard.svg
pankmer upset -i Drosophila_index.tar -o Drosophila_index_upset.svg -g Drosophila_melanogaster_GCF_000001215.4 Drosophila_simulans_GCF_016746395.2 Drosophila_sechellia_GCF_004382195.2 Drosophila_suzuki_GCF_043229965.1
```

Lets look at the plots you generated. First one shows the Jaccard Similarity Index.
...
Lets look at the percentage of each genome that actually mapped.
...
all = NULL
for (i in list.files("data/", pattern = "paf.stats")){
...
cd ..
cd ntsynt
ntSynt -d 15 ../data/*.fasta #this might take at most 10min
genome_to_colour=$(head -n1 ntSynt.k24.w1000.synteny_blocks.tsv | cut -f2) 
SOFTWARE_DIR=/home/zajac/scripts/Software #to change
...
args = NULL
args$sequences = "data/ggggenomes_viz.sequence_lengths.tsv"
args$links = "data/ggggenomes_viz.links.tsv"
args$scale = 10000 
...
synteny = NULL
variants = NULL
syri_summary_files = list.files("data/", patter = "summary")
n=1
...
In order to understand if the poor mapping quality or the low genome composition similarity is due to repetitive content of the genome I annotated repeats with RepeatModeler and RepeatMasker. I ran the following code for you already:
...
files_fai = list.files("data/", patter = "fai")
...
```{r}
library(SVbyEye)
paf.table = readRDS("data/chrX.paf.rds")
