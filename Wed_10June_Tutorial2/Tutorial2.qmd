...
``` bash
singularity exec pggb_latest.sif pggb -i data/Adh_Drosophila/chr2L_Adh.fasta --map-pct-id 60 -n 4 -t 16 -o Adh_pggb_p60 -S
```
...
``` bash
singularity exec pggb_latest.sif pggb -i data/Adh_Drosophila/chr2L_Adh.fasta --segement-length <here_put_the_length> -n 4 -t 16 -o Adh_pggb_<define_the_name> -S
```
...
``` bash
singularity exec pggb_latest.sif pggb -i data/Adh_Drosophila/chr2L_Adh.fasta --segement-length <here_put_the_length> --map-pct-id 60 -n 4 -t 16 -o Adh_pggb_<define_the_name> -S
```
...
``` bash
singularity exec pggb_latest.sif pggb -i data/Adh_Drosophila/chr2L_Adh.fasta --segement-length <here_put_the_length> --map-pct-id 90 -G 1400,1600,2000,2200 -n 4 -t 16 -o Adh_pggb_<define_the_name> -S
```
...
``` bash
singularity exec pggb_march_2026.sif vg construct --msa MSA.fasta > graph.vg
singularity exec pggb_march_2026.sif vg convert -f -W graph.vg > graph.gfa
singularity exec pggb_march_2026.sif odgi unchop -i graph.gfa -o - | singularity exec pggb_march_2026.sif odgi sort -i - -o - | singularity exec pggb_march_2026.sif odgi view -i - -g > graph.mod.gfa
singularity exec pggb_march_2026.sif odgi build -g graph.mod.gfa --sort -o graph.og 
singularity exec pggb_march_2026.sif odgi viz -i graph.og -o graph.png
```
