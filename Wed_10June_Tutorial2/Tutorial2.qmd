...
do 
  singularity exec ../pggb.sif pggb -i ../data/pggb/Adh_chr2L.fasta --segment-length $i -n 4 -t 16 -o Adh_pggb_s${i} -S; 
done
```
...
for i in 100 500; 
do 
  singularity exec ../pggb.sif pggb -i ../data/pggb/Adh_chr2L.fasta --segment-length $i --map-pct-id 60 -n 4 -t 16 -o Adh_pggb_s${i}_p60 -S; 
done
```
